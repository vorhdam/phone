...
It also uses my [Flag Component](https://github.com/vorhdam/flags) to improve UX and make countries easier to find. The last dependency is of course the [libphonenumber-js](https://www.npmjs.com/package/libphonenumber-js) NPM package which validates the phone numbers.
